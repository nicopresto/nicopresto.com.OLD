...
auth.settings.hmac_key = 'sha512:945306d4-0286-43d6-83ac-8e6a79dbc6a0'   # before define_tables()
...
db.define_table('funding',
Field('title'),
Field('year', 'integer')
)

db.define_table('teaching',
Field('course'),
Field('title'),
Field('description')
)

db.define_table('mentoring',
Field('role'),
Field('description')
)

db.define_table('societies',
Field('name'),
Field('acronym')
)

db.define_table('referee',
Field('journal'),
Field('acronym')
)
